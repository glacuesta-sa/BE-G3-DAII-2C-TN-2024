...
def recital_topic_handler(event, context):
    try:
        ...
        recital_topic_arn = "arn:aws:sns:us-east-1:442042507897:recital-topic"
...
def ticket_topic_handler(event, context):
    try:
        ...
        ticket_topic_arn = "arn:aws:sns:us-east-1:442042507897:ticket-topic"
...
def transaccion_topic_handler(event, context):
    try:
        print(f"Evento recibido: {json.dumps(event)}")
        detail = event.get('detail', {})

        ticket_topic_arn = "arn:aws:sns:us-east-1:442042507897:transaccion-topic"
        
        subject = detail.get('subject', 'Transaccion')
...
def wallet_topic_handler(event, context):
    try:
        ...
        ticket_topic_arn = "arn:aws:sns:us-east-1:442042507897:wallet-topic"
